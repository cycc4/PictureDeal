...
public abstract class GroupParser<T extends GroupData> extends BaseWidgetParser<T> {
     ...
     */
    public Group groupChildrenParse(BaseCocoStudioUIEditor editor, T widget, Group parent, Actor actor) {
        Group group = (Group) actor;

        // Group 虽然自己不接收事件,但是子控件得接收
        actor.setTouchable(widget.TouchEnable ? Touchable.enabled : Touchable.childrenOnly);
