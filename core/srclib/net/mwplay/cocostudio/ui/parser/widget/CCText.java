...
public class CCText extends WidgetParser<TextObjectData> {

    @Override
    public Class getClassName() {
        return TextObjectData.class;
    }

    @Override
    public Actor parse(BaseCocoStudioUIEditor editor, TextObjectData widget) {

        final Label.LabelStyle labelStyle = editor.createLabelStyle(widget, widget.LabelText, NUtils.getColor(widget.CColor, 0));
