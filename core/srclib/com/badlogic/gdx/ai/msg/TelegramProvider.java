 ...
 * @author avianey
 */
public interface TelegramProvider<T> {
    /**
     ...
     * @see com.badlogic.gdx.ai.msg.MessageDispatcher#addListener(Telegraph, String)
     * @see com.badlogic.gdx.ai.msg.MessageDispatcher#addListeners(Telegraph, String...)
     */
    Object provideMessageInfo(T msg, Telegraph receiver);
}
