...
//    };
    ...
    private Array<ManagerUIEditor> cocoStudioUIEditors = new Array<>();
    ...
    public Array<AssetDescriptor> getDependencies(String fileName, FileHandle file, ManagerUIParameter parameter) {
        ...
        System.out.println("manager ui loader load: " + fileName);
        for (String name : list) {
            String fname = cocoStudioUIEditor.filedir + name;
            fname = dealDot(fname);
            if (name.endsWith(".png") || name.endsWith(".jpg")) {
                assetDescriptors.add(new AssetDescriptor<>(fname, Texture.class, AssetsParameters.uiTextureParameter));
            } else if (name.endsWith(".json"))
                assetDescriptors.add(new AssetDescriptor<>(fname, ManagerUIEditor.class, parameter));
            else if (name.endsWith(".plist"))
                assetDescriptors.add(new AssetDescriptor<>(fname, PlistAtlas.class, AssetsParameters.uiPlistAtlasParameter));
            else if (name.endsWith(".fnt"))
                assetDescriptors.add(new AssetDescriptor<>(fname, BitmapFont.class, AssetsParameters.uiBitmapFontParameter));
            else
