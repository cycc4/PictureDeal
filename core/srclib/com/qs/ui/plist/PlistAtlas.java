    ...
    public static class PlistAtlasData {
        ...
        public PlistAtlasData(FileHandle packFile, FileHandle imagesDir, TextureFilter minFilter, TextureFilter maxFilter) {
            try {
                ...
                TextureFilter mag = maxFilter != null ? maxFilter : TextureFilter.Linear;
...
//                Page pageImage = new Page(file, textureWidth, textureHeight, min.isMipMap(), format, min, mag, repeatX, repeatY);
                Page pageImage = new Page(file, textureWidth, textureHeight, min.isMipMap(), format, min, mag, repeatX, repeatX);
...
//                    region.offsetY = offdown;
                    region.offsetX = (oriwidth - width) / 2 + offleft;
                    region.offsetY = (oriheight - height) / 2 + offdown;
