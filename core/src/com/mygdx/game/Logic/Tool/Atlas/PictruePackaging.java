...
//import com.mygdx.game.CombinationPicture.CombinationSetting;
//
//import java.io.File;
//
///**
...
//        process(CombinationSetting.getTexturePackerSetting(), pngFile, atlasFile, null);
//    }
//
//    public static void process(File pngFile, File atlasFile, TexturePacker.ProgressListener progress) {
//        process(CombinationSetting.getTexturePackerSetting(), pngFile, atlasFile, progress);
//    }
//
