...
public class PictureTrail extends Actor implements Pool.Poolable {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        float c = Color.toFloatBits(color.r, color.g, color.b, color.a * parentAlpha);
        ...
        ((PolygonSpriteBatch) batch).draw(region.getTexture(), vertices, 0, totalPositions * 10, indices, 0, totalPositions * 6 - 6);
    }
